...
@property (strong, nonatomic) IBOutlet UITableView *callListTableView;
...
- (void)dealloc {
    _callListTableView.delegate = nil;
    _callListTableView.dataSource = nil;
}
...
- (IBAction)pushHistory:(id)sender {
    CallHistoryViewController *history = [[CallHistoryViewController alloc] init];
    [self.navigationController pushViewController:history animated:YES];
}

- (void)initUI {
    _callListTableView.delegate = self;
    _callListTableView.dataSource = self;
}
...
- (void)handleData {
    NSString *urlStr = [NSString stringWithFormat:@"%@%@", BASEURL, call_list];
